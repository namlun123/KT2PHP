...
<head>
    ...
    <script>
        ...
        function tinhTongTien() {
            ...
            var VAT = total * 0.1; // Assuming VAT is 10%
            ...
            tinhThanhTien(); // Calculate total amount including VAT and shipping
        }

        // Hàm tính thành tiền tổng cộng
        function tinhThanhTien() {
            var total = parseFloat(document.getElementById("tongtien").innerText.replace(" VNĐ", "").replace(/,/g, "")) || 0;
            var VAT = parseFloat(document.getElementById("VAT").innerText.replace(" VNĐ", "").replace(/,/g, "")) || 0;
            var shippingCost = parseFloat(document.getElementById("shippingCost").innerText.replace(" VNĐ", "").replace(/,/g, "")) || 0;

            var totalAmount = total + VAT + shippingCost;
            document.getElementById("thanhTienTong").innerText = totalAmount.toLocaleString() + " VNĐ";
        }
    </script>
</head>
<body>
