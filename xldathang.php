...
if (isset($_SESSION["user"])) {
    $user = $_SESSION["user"]; 
        ...
        if ($result->num_rows > 0) {
            ...
            // Cập nhật thông tin nhận hàng và thay đổi trạng thái chế độ đơn hàng thành 1 
            $update_dondathang = "UPDATE dondathang SET nguoinhanhang='$nguoinhanhang', sodienthoai='$sodienthoai', diachinhanhang='$diachinhanhang', thanhpho='$province', chedo=1, 
            ngaydathang=NOW() WHERE sohoadon='$sohoadon' AND nguoidathang='$user' AND chedo=0";
        ...
        if ($result->num_rows > 0) {
            ...
            $update_dondathang = "UPDATE dondathang SET nguoinhanhang='$nguoinhanhang', sodienthoai='$sodienthoai', diachinhanhang='$diachinhanhang', thanhpho='$province', chedo=1, 
            ngaydathang=NOW() WHERE nguoidathang='$user' AND chedo=0";
            $con->query($update_dondathang);
